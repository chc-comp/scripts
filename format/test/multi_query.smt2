...
(assert
  (forall ( (|$V-reftype:8| Int) (|$alpha-1:x| Int) (|$knormal:1| Int) )
    (=>
      ...
      (unknown |$V-reftype:8| |$V-reftype:8|)
    )
  )
)
(assert
...
(assert
  (not (exists ( (|$alpha-2:n| Int) (|$knormal:6| Int) (|$knormal:7| Int) (|$knormal:9| Int) )
    ( and (= (not (= 0 |$knormal:9|)) (= |$knormal:7| 91)) (= (not (= 0 |$knormal:6|)) (<= |$alpha-2:n| 101)) (not (not (= 0 |$knormal:9|))) (not (= 0 |$knormal:6|)) (unknown |$knormal:7| |$knormal:7|) )
    )
  )
)
(assert
  (not (exists ( (|$alpha-2:n| Int) (|$knormal:6| Int) (|$knormal:7| Int) (|$knormal:9| Int) )
    ( and (= (not (= 0 |$knormal:9|)) (= |$knormal:7| 91)) (= (not (= 0 |$knormal:6|)) (<= |$alpha-2:n| 3)) (not (not (= 0 |$knormal:9|))) (not (= 0 |$knormal:6|)) (unknown |$knormal:7| |$knormal:7|) )
    )
  )
)
(assert
